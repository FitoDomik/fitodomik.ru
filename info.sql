...
--
-- Хост: localhost
-- Время создания: Окт 28 2025 г., 20:35
...
--
-- Дамп данных таблицы `code_links`
--

INSERT INTO `code_links` (`id`, `title`, `url`, `description`, `is_active`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, '⭐Основной репозиторий проекта ФитоДомик⭐', 'https://github.com/FitoDomik/FitoDomik_project', 'ФитоДомик — это умная система для автоматизации ухода за домашними растениями. Проект объединяет аппаратную часть на базе Arduino с программным обеспечением на Python для создания интеллектуальной теплицы, которая:\r\n\r\nМониторит условия выращивания (влажность, температуру, освещенность)\r\nАвтоматически управляет поливом, освещением, вентиляцией\r\nАнализирует состояние растений с помощью машиного зрения\r\nПредоставляет наглядную визуализацию данных и удобный интерфейс управления\r\nИдеально подходит для любителей растений, которые хотят автоматизировать уход за своими зелеными питомцами и создать оптимальные условия для их роста.', 1, 0, '2025-09-02 17:25:07', '2025-09-02 17:25:07'),
(2, 'Сайт Визитка', 'https://github.com/FitoDomik/fitodomik.ru', '', 1, 0, '2025-09-02 17:25:47', '2025-09-02 17:25:47'),
(3, 'Сайт для управления умной фермой', 'https://github.com/FitoDomik/fitodomik.online', '', 1, 0, '2025-09-02 17:26:03', '2025-09-02 17:26:03');
...
CREATE TABLE `components` (
  ...
  `price_type` enum('bought','custom','undefined') COLLATE utf8mb4_unicode_ci DEFAULT 'undefined',
  `status` enum('bought','not_bought') COLLATE utf8mb4_unicode_ci DEFAULT 'not_bought',
...
INSERT INTO `components` (`id`, `name`, `quantity`, `price`, `price_type`, `status`, `info`, `created_at`, `updated_at`) VALUES
(35, 'Arduino Nano v3.0', 1, 260.00, 'custom', 'bought', 'Микроконтроллер, получает и обрабатывает сигналы с датчиков, передаёт их на Raspberry Pi для принятия решений', '2025-08-04 10:17:24', '2025-08-04 10:29:17'),
(36, 'BME280', 1, 158.00, 'custom', 'bought', 'Датчик температуры, влажности и атмосферного давления', '2025-08-04 10:17:47', '2025-08-04 10:28:56'),
(37, 'MH-Z19B', 1, 1300.00, 'custom', 'bought', 'Датчик углекислого газа (CO₂), измеряет концентрацию CO₂ в воздухе', '2025-08-04 10:18:01', '2025-08-04 10:28:33'),
(38, 'YL-69 (FC-28)', 1, 169.00, 'custom', 'bought', '', '2025-08-04 10:18:47', '2025-08-04 10:18:47'),
(39, 'DS3231 RTC модуль', 1, 190.00, 'custom', 'bought', 'Модуль реального времени, обеспечивает точное время и дату для автоматических действий', '2025-08-04 10:19:02', '2025-08-04 10:28:15'),
(40, '4-канальный релейный модуль', 1, 318.00, 'custom', 'bought', 'Позволяет управлять электроприборами (насосом, освещением, вентилятором, шторами) по сигналу от  Arduino', '2025-08-04 10:19:23', '2025-08-04 10:27:50'),
(41, 'USB Web-камера', 1, 200.00, 'custom', 'bought', 'Используется для видеонаблюдения за состоянием растения', '2025-08-04 10:19:32', '2025-08-04 10:27:03'),
(42, 'Блок питания 12В/2А', 1, 0.00, 'custom', 'bought', 'Источник питания для питания модулей и контроллеров\r\n\r\nМожно взять от любого прибора\r\n', '2025-08-04 10:20:18', '2025-08-04 10:26:42'),
(43, 'Провод 1м', 1, 180.00, 'custom', 'bought', 'Соединительные провода для подключения компонентов между собой', '2025-08-04 10:20:27', '2025-08-04 10:26:22'),
(44, 'Домен fitodomik.ru', 1, 119.00, 'custom', 'bought', 'Домен fitodomik.ru и Домен fitodomik.online + Хостинг веб-платформы + SSL сертификат 119 ₽/год ', '2025-08-04 10:21:37', '2025-08-04 10:21:37'),
(46, 'Микрокомпьютер Raspberry Pi 3 Model B', 1, 2500.00, 'custom', 'bought', '', '2025-08-04 10:23:58', '2025-08-04 10:23:58'),
(47, 'Лампа', 1, 360.00, 'custom', 'bought', 'Для освещения растений', '2025-08-04 10:29:46', '2025-08-04 10:29:46'),
(48, 'Вентилятор', 1, 150.00, 'custom', 'bought', 'Служит для поддержания температуры\r\n\r\nМожно взять любой', '2025-08-04 10:30:26', '2025-08-04 10:30:26'),
(49, 'МИНИ-НАСОС для воды погружной', 1, 120.00, 'custom', 'bought', 'Для поддержания влажности почвы', '2025-08-04 10:32:01', '2025-08-04 10:32:01');
...
('5.228.163.201', '2025-08-04 07:11:16');
...
(44, '12', '12', 'question', NULL, '5.228.163.201', 0, 0, '2025-08-04 07:11:16');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `username`, `password`, `is_admin`, `created_at`, `updated_at`, `last_login`, `login_attempts`, `is_locked`, `reset_token`, `reset_token_expires`) VALUES
(12, 'Александр', 'Шмелев', 'yayca444@mail.ru', 'anakonda', '$2y$10$OyP4fQz.5OY.arUQW748Z.4/9vukMkpQtNX1kmqDPNG/FDQfQ7WJm', 1, '2025-04-07 11:45:49', '2025-05-25 10:08:01', '2025-04-07 12:00:56', 0, 0, NULL, NULL),
(13, 'Илья', 'Изразцов', 'ipidor@gmail.com', 'Izik', '$2y$10$.YcdN..w/Thc/5ZV5qktAu0k/StWH4mLwcbh2wYve62ka5705LfqO', 1, '2025-04-07 12:00:52', '2025-05-25 10:08:01', '2025-04-07 12:00:59', 0, 0, NULL, NULL),
(17, 'Slavik10', 'Slavik10', 'SLavik10@SLavik10.com', 'Slavik10', '$2y$10$4gujtqY6tJmT4QALID86UeDhkZFg6sLSWBZeNtGuVS9qHqKrfUjqC', 1, '2025-08-04 07:13:35', '2025-09-02 17:23:33', '2025-09-02 17:23:13', 0, 0, NULL, NULL);
...
(0, 17, 'password_change', 'SYSTEM', NULL, '2025-09-02 17:23:33');
