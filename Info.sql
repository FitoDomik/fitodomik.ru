...
--
-- Хост: localhost
-- Время создания: Авг 07 2025 г., 17:14
...
CREATE TABLE `code` (
  ...
  `language` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'text',
...
--
-- Структура таблицы `code_links`
--

CREATE TABLE `code_links` (
  `id` int NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Название ссылки для отображения',
  `url` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'URL ссылки',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT 'Описание ссылки (опционально)',
  `is_active` tinyint(1) DEFAULT '1' COMMENT 'Активна ли ссылка',
  `sort_order` int DEFAULT '0' COMMENT 'Порядок сортировки',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Ссылки на репозитории кода';
...
CREATE TABLE `feedback` (
  ...
  `status` enum('new','in_progress','completed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'new',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `is_answered` tinyint(1) DEFAULT '0',
  `is_faq` tinyint(1) DEFAULT '0',
  `type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'Обратная связь'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- AUTO_INCREMENT для таблицы `code_links`
--
ALTER TABLE `code_links`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
